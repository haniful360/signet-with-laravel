  ...
  <div class="ud-header absolute top-0 right-0 left-0 z-50  bg-primary">
      <div class="max-w-[1320px] mx-auto">
          <div style='height:77px' class="relative flex items-center justify-between ">
              <div class="w-60 max-w-full px-4">
                  <a href="{{ url('/') }}" class="block w-full py-5">
                      <img src="{{asset('images/logo/logo.png')}}" alt="logo" class=" w-[70px] h-[62px]" />
                  </a>
              </div>
              <!-- menu -->
              <div class="flex w-full  items-center justify-between px-4 ">
                  <div>
                      ...
                      <nav id="navbarCollapse"
                          class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white dark:bg-dark-2 py-5 shadow-lg lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent dark:lg:bg-transparent hidden lg:py-0 lg:px-4 lg:shadow-none xl:px-6">
                          <ul class="blcok lg:flex gap-2">
                              <li class="group relative">
                                  <a href="{{ url('/') }}"
                                      class=" relative  flex mx-8 py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Home
                                  </a>
                              </li>
                              <li class="submenu-item group relative">
                                  <a href="javascript:void(0)"
                                      class="relative ud-menu-scroll mx-8 flex items-center  py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-5 lg:mr-0 lg:inline-flex lg:py-6 lg:pl-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Services
                              ...
                              <li class="submenu-item group relative">
                                  <a href="javascript:void(0)"
                                      class="relative mx-8 flex items-center py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-5 lg:mr-0 lg:inline-flex lg:py-6 lg:pl-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Training
                                      <svg class="ml-2 fill-current" width="16" height="20" viewBox="0 0 16 20"
                                          fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path
                                  ...
                                  <div
                                      class="submenu relative left-0 top-full hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                      <a href="{{route('signet.training')}}"
                                          class="block rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary">
                                          Trainings
                                      </a>
                                      <a href="{{route('signet.training-schedule')}}"
                                          class="block rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary">
                                          Trainings Schedule
                                      </a>
                                  </div>
                              ...
                              <li class="group relative">
                                  <a href="{{route('signet.certificate-check')}}"
                                      class="mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-5 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Certificate Check
                                  </a>
                              </li>
                              <li class="group relative">
                                  <a href="{{route('signet.quote')}}"
                                      class="mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-5 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Get Quote
                                  </a>
                              </li>
                              <li class="group relative">
                                  <a href="{{ route('signet.contact') }}"
                                      class="mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-5 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                                      Contact Us
                                  </a>
                              </li>
