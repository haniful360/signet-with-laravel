            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                        <img src="{{ asset('images/logo/logo.png') }}" alt="logo" class="w-[70px] h-[70px]" />
                    </a>
                    ...
                    <div class="flex flex-col gap-8">
                        <a href="#" class="group flex items-center gap-[22px]">
                            <div class="overflow-hidden rounded">
                                <img src="{{ asset('images/blog/blog-footer-02.jpg') }}" alt="blog" />
                            </div>
                        ...
                        <a href="#" class="group flex items-center gap-[22px]">
                            <div class="overflow-hidden rounded">
                                <img src="{{ asset('images/blog/blog-footer-01.jpg') }}" alt="blog" />
                            </div>
                            <span class="max-w-[180px] text-base text-gray-7 group-hover:text-white">
